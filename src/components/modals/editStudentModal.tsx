...
import { EditDto, IUser, SignUpDto } from "@/models/index.model";
...
export default function EditStudentModal({
  ...
  const editUser = async (id: number) => {
    ...
    try {
      const res = await AdminServices.editUser(data, id);
      if (res.statusCode == "OK") {
        toast({
          title: "Create",
          description: "Student profile modified",
          duration: 2000,
          status: "success",
        });
        router.reload();
        ...
        <ModalFooter>
          <div className="w-full flex flex-col lg:flex-row lg:justify-end items-center gap-2 items-center">
            ...
            <button
              ...
              onClick={() => {
                editUser(parseInt(id as string));
              }}
            >
              {" "}
