    ...
    <div className="w-full bg-[#F2F3F5] rounded-xl h-full p-5 flex flex-col justify-between">
      <div className="flex flex-col  gap-4">
        ...
        >
          ...
          <p className={` text-[14px]`}>Manage Sports</p>
        </div>
        <div
          className={`w-full flex gap-3 cursor-pointer items-center font-semibold hover:text-black ease-in-out duration-700 px-5 py-2 rounded-lg  ${
            router.asPath == "/admin/events" ? "text-black " : "text-[#5E6278]"
          }`}
          onClick={() => {
            router.push("/admin/events");
          }}
        >
          {router.asPath == "/admin/events" ? (
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
          ...
          <p className={` text-[14px]`}>Manage Events</p>
        </div>
        <div
          className={`w-full flex gap-3 cursor-pointer items-center font-semibold hover:text-black ease-in-out duration-700 px-5 py-2 rounded-lg  ${
            router.asPath == "/admin/coaches" ? "text-black " : "text-[#5E6278]"
          }`}
          onClick={() => {
            router.push("/admin/coaches");
          }}
        >
          {router.asPath == "/admin/coaches" ? (
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
          ...
          <p className={` text-[14px]`}>Manage Coaches</p>
        </div>
