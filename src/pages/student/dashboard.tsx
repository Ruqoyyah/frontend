      ...
      <div className="flex w-full h-full flex-row">
        <div className="p-5 w-full flex h-full overflow-scroll flex-col gap-7 ">
          <div className="flex flex-col gap-1">
            <p className="text-xl font-semibold">Hello {student?.firstname} </p>
          ...
          <div className="w-full bg-white rounded-xl  flex flex-col gap-5">
            <div className="w-full flex justify-between items-center">
              ...
              <div className="flex items-center gap-2 justify-end">
                ...
                <button
                  className="flex gap-2 items-center text-white px-5 py-2 rounded-lg bg-[#FF9C50] text-sm font-semibold"
                  onClick={() => {
                    onOpen();
                  }}
                >
